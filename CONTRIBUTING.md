...
issue](https://github.com/cisagov/travis-wait-improved/issues) in
...
request](https://github.com/cisagov/travis-wait-improved/pulls),
...
```console
cd travis-wait-improved
pyenv virtualenv <python_version_to_use> travis-wait-improved
pyenv local travis-wait-improved
